<form>
<input type="text" placeholder="Search product" id="search_value" onkeyup="showLiveResult(this.value)">
<input type="button" value="Search" id="search_all" onclick="showAllResult() " />
